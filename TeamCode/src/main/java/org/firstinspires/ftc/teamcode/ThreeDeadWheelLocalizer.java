...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -1185.3476148731886; //(2000/5.937) * -(2+ (double) 3/8); // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 1007.4779470400238; //(2000/5.937) * (2+ (double) 3/8); // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2706.175894461234; //(2000/5.937) * (-7.75); // x position of the perpendicular encoder (in tick units)
    }
