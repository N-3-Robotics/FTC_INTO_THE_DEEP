...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 1075.7738388811608; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1646.0902338062774; // x position of the perpendicular encoder (in tick units)
    }
