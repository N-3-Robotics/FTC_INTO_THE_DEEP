...
//        HEADING OFFSET = -0.9966


        // RR localizer note: These units are inches and radians.
        public SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(0,  5.3406, Math.toRadians(-179.1650));
        ...
        public double linearScalar = -((48/42.3161) + (48/46.2088) + (48/46.2089))/3;
        public double angularScalar = -0.9966;
    }
    ...
    public SparkFunOTOSDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        otos = hardwareMap.get(SparkFunOTOSCorrected.class,"ODOMETER");
        // RR localizer note:
